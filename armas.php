...
<body>
   ...
   <nav>
    ...
    <div id="fotosarmas">
        <div id="armica">
            <a href="pistolas.php"><img id="armica" src="gato1.jpg" alt="gato"></a>
            <div id="jug1">
                <h1 id="jugs">PACO</h1>
            </div>
        </div>
        <div id="armica">
            <a href="metralletas.php"><img id="armica" src="gato1.jpg" alt="gato"></a>
            <div id="jug1">
                <h1 id="jugs">JUAN</h1>
            </div>
        </div>
    ...
    <div id="fotosarmas">
        <div id="armica">
            <a href="armaspesadas.php"><img id="armica" src="gato1.jpg" alt="gato"></a>
            <div id="jug1">
                <h1 id="jugs">PACO</h1>
            </div>
        </div>
        <div id="armica">
            <a href="granadas.php"><img id="armica" src="gato1.jpg" alt="gato"></a>
            <div id="jug1">
                <h1 id="jugs">PEDRO</h1>
            </div>
        </div>
