   ...
   <nav>
    ...
    <tbody>
        ...
        <?php
            ...
            $sql = "SELECT * FROM mouse where id=4";
    ...
    <tbody>
        <tr>
        <?php
                $sql = "SELECT * FROM crosshair where id=4";
    ...
    <tbody>
        <tr>
        <?php
                $sql = "SELECT * FROM viewmodel where id=4";
    ...
    <tbody>
        <tr>
        <?php
                $sql = "SELECT * FROM video where id=4";
    ...
    <tbody>
        <tr>
        <?php
                $sql = "SELECT * FROM adv where id=4";
