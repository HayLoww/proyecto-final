   ...
   <nav>
    ...
    <tbody>
        ...
        <?php
            ...
            $sql = "SELECT * FROM mouse where id=2";
    ...
    <tbody>
        <tr>
        <?php
                $sql = "SELECT * FROM crosshair where id=2";
    ...
    <tbody>
        <tr>
        <?php
                $sql = "SELECT * FROM viewmodel where id=2";
    ...
    <tbody>
        <tr>
        <?php
                $sql = "SELECT * FROM adv where id=2";
